...
VALUES
    ...
    ('ASAI_MILD_RESULT_YIELDS_ON', 'Amount', '20, 15, 15'),
    ('ASAI_MILD_RESULT_YIELDS_OFF', 'YieldType',
     'YIELD_PRODUCTION, YIELD_SCIENCE, YIELD_CULTURE'),
    ('ASAI_MILD_RESULT_YIELDS_OFF', 'Amount', '-20, -15, -15'),
    ('ASAI_SEVERE_RESULT_YIELDS_ON', 'YieldType',
     'YIELD_PRODUCTION, YIELD_SCIENCE, YIELD_CULTURE'),
    ('ASAI_SEVERE_RESULT_YIELDS_ON', 'Amount', '40, 30, 30'),
    ('ASAI_SEVERE_RESULT_YIELDS_OFF', 'YieldType',
     'YIELD_PRODUCTION, YIELD_SCIENCE, YIELD_CULTURE'),
    ('ASAI_SEVERE_RESULT_YIELDS_OFF', 'Amount', '-40, -30, -30');
