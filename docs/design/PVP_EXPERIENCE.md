...
当前代码落地了 0.4.0 的稳定性基础、0.5.0 的个体结果闭环和 0.5.1 的响应/预算修复：
...
尚未实现：世界分布、完整自身趋势、滚动策略组合、玩家模型、完整战争目标与路线、城市专精、外交/交易/间谍、完整胜利里程碑及静态难度配置拆分。0.5.1 没有固定或锁定胜利路线；游戏原有胜利策略仍可随局势变化。文档描述的滚动组合是后续设计合同，不代表当前版本已经具备。
