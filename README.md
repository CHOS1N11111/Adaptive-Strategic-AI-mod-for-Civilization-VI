...
# Adaptive Strategic AI 0.8.1

Adaptive Strategic AI is not a cheat pack that feeds hidden resources to the AI. It is an auditable, measurable AI engineering baseline for Gathering Storm. Testing should use a new game starting in the Ancient Era. Release 0.8.1 preserves the successful opening behavior observed in a complete turn 1-49 Online Speed review while reducing duplicate civilian orders, finishing first trade-capacity buildings more reliably, and strengthening culture production only after measured execution failure.
...
- In 0.8.1, production, districts, trade, and conversion diagnostics still do not enter the seven-component overall score. Only whether current production responds to the selected focus can temporarily raise native AI execution weights.
