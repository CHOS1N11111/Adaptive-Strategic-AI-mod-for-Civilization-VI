...
Adaptive Strategic AI reshapes Civilization VI: Gathering Storm AI behavior around expansion, economic development, military readiness, and competitive pacing. Version 0.11.1 retains the rolling strategic coordinator and makes military-pressure reviews outcome-aware, so additional military strength alone cannot keep an unproductive pressure plan alive.
...
- Loading a 0.11.0 save migrates an active pressure review once by rebuilding its baseline under the new outcome definition. Other plan state is preserved, and the migration is persisted so later reloads do not repeat it.
...
- Military readiness is an independent sensor that can win the primary budget as the defense plan. It enters after two evaluations at or below 78% of the stronger competitive reference, enters immediately when raw strength falls to 60%, or enters from Standard-equivalent turn 50 when combat-unit density is at or below 1.75 per planned city. While defense is selected, it favors a mixed standing army and maintains combat production below a rounded-up 25%-of-cities target. Active major war replaces defense with the stronger war plan instead of stacking both intervention sets.
...
- Science at or below 88%, culture at or below 85%, and empire at or below 85% of the stronger competitive reference can become support candidates, but only the weakest eligible pillar activates. Their exit thresholds are 96%, 95%, and 95%. War, defense, and expansion block an empire support focus that would conflict with their primary budget.
