...
# Adaptive Strategic AI 0.8.3

Adaptive Strategic AI is not a cheat pack that feeds hidden resources to the AI. It is an auditable, measurable AI engineering baseline for Gathering Storm. Testing should use a new game starting in the Ancient Era. Release 0.8.3 adds persistent scale recovery after the same complete turn 1-76 Online Speed review showed that peaceful AIs detected their empire deficit but could not preserve enough expansion and foundational economic throughput to remain credible competitors.
...
- In 0.8.3, production, districts, trade, military composition, and conversion diagnostics still do not enter the seven-component overall score. Focus response, military readiness, and scale recovery can temporarily raise bounded native AI execution weights.
