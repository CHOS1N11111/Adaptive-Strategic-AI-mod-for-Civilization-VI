# Adaptive Strategic AI 0.6.0

这不是“给 AI 偷资源”的作弊包，而是一个可审计、可测量的 AI 工程基线。当前只支持 Gathering Storm，建议远古时代开局并新建游戏测试。0.6.0 在 0.5.2 的全体 AI 竞争护栏之外，增加只读的生产与经济转化诊断；新指标暂不进入评分或改变策略，以便先验证数据是否可靠。
...
- 每次控制器评估同时诊断总/每城生产力、人口区域槽、商人容量、改良覆盖、当前生产分类、金币储备、战略资源库存和单位升级积压，用于区分“缺城市”和“城市没有转化为有效资产”。
...
- 0.6.0 的生产、区域、商路、资源和升级数据只写日志，不属于上述七项总分，也不触发额外扶持或压制。
